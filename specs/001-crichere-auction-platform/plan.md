...
**Language/Version**: Kotlin 1.9.23 (Backend), Dart (Flutter Stable)  
**Primary Dependencies**: 
- **Backend**: Spring Boot 3.2.4, Spring Security, Spring Data JPA, Spring Data Redis (SSE pub/sub), AWS SDK v2 (S3), MSG91 (SMS), FCM (Push), ShedLock, Flyway, JJWT.
