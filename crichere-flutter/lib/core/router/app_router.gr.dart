...
import 'package:crichere_flutter/features/league/presentation/screens/pre_assignment_screen.dart'
    as _i17;
import 'package:crichere_flutter/features/league/presentation/screens/pricing_screen.dart'
    as _i18;
...
class AdminUsersRoute extends _i23.PageRouteInfo<void> {
  const AdminUsersRoute({List<_i23.PageRouteInfo>? children})
...
class AuctioneerPanelRoute
    extends _i23.PageRouteInfo<AuctioneerPanelRouteArgs> {
...
class ClaimProfileRoute extends _i23.PageRouteInfo<ClaimProfileRouteArgs> {
  ClaimProfileRoute({
    _i24.Key? key,
...
class FeeManagementRoute extends _i23.PageRouteInfo<FeeManagementRouteArgs> {
  FeeManagementRoute({
    _i24.Key? key,
    required String leagueId,
    List<_i23.PageRouteInfo>? children,
...
class ForfeitManagementRoute
    extends _i23.PageRouteInfo<ForfeitManagementRouteArgs> {
...
class FranchiseInviteRoute
    extends _i23.PageRouteInfo<FranchiseInviteRouteArgs> {
...
class FranchiseSquadRoute extends _i23.PageRouteInfo<FranchiseSquadRouteArgs> {
  FranchiseSquadRoute({
    _i24.Key? key,
...
class LeagueCreateRoute extends _i23.PageRouteInfo<void> {
  const LeagueCreateRoute({List<_i23.PageRouteInfo>? children})
...
class LeagueDetailRoute extends _i23.PageRouteInfo<LeagueDetailRouteArgs> {
  LeagueDetailRoute({
    _i24.Key? key,
    required String leagueId,
    List<_i23.PageRouteInfo>? children,
...
class LiveAuctionViewerRoute
    extends _i23.PageRouteInfo<LiveAuctionViewerRouteArgs> {
...
class PhoneEntryRoute extends _i23.PageRouteInfo<void> {
  const PhoneEntryRoute({List<_i23.PageRouteInfo>? children})
...
class PlatformAdminRoute extends _i23.PageRouteInfo<void> {
  const PlatformAdminRoute({List<_i23.PageRouteInfo>? children})
...
class PostAuctionRoute extends _i23.PageRouteInfo<PostAuctionRouteArgs> {
  PostAuctionRoute({
    _i24.Key? key,
    required String auctionId,
    List<_i23.PageRouteInfo>? children,
...
class PreAssignmentRoute extends _i23.PageRouteInfo<PreAssignmentRouteArgs> {
  PreAssignmentRoute({
    _i24.Key? key,
    required String leagueId,
    List<_i23.PageRouteInfo>? children,
...
/// generated route for
/// [_i18.PricingScreen]
class PricingRoute extends _i23.PageRouteInfo<PricingRouteArgs> {
  PricingRoute({
    _i24.Key? key,
    required String leagueId,
    List<_i23.PageRouteInfo>? children,
         ...
         PricingRoute.name,
         args: PricingRouteArgs(key: key, leagueId: leagueId),
         initialChildren: children,
       );
  ...
  static _i23.PageInfo page = _i23.PageInfo(
    name,
    builder: (data) {
      final args = data.argsAs<PricingRouteArgs>();
      return _i18.PricingScreen(key: args.key, leagueId: args.leagueId);
    },
  );
}

class PricingRouteArgs {
  const PricingRouteArgs({this.key, required this.leagueId});
  ...
  @override
  String toString() {
    return 'PricingRouteArgs{key: $key, leagueId: $leagueId}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! PricingRouteArgs) return false;
    return key == other.key && leagueId == other.leagueId;
  }
...
/// generated route for
/// [_i20.ProfileSetupScreen]
class ProfileSetupRoute extends _i23.PageRouteInfo<void> {
  const ProfileSetupRoute({List<_i23.PageRouteInfo>? children})
  ...
  static _i23.PageInfo page = _i23.PageInfo(
    name,
    builder: (data) {
      return const _i20.ProfileSetupScreen();
    },
  );
}

/// generated route for
/// [_i21.SpectatorScreen]
class SpectatorRoute extends _i23.PageRouteInfo<SpectatorRouteArgs> {
  SpectatorRoute({
    _i24.Key? key,
    required String token,
    List<_i23.PageRouteInfo>? children,
  ...
  static _i23.PageInfo page = _i23.PageInfo(
    ...
    builder: (data) {
      ...
      return _i21.SpectatorScreen(key: args.key, token: args.token);
    },
  );
}
