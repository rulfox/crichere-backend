...
class _PlayerApi implements PlayerApi {
  _PlayerApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<LeaguePlayer> registerPlayer(Map<String, dynamic> body) async {
  ...
  @override
  Future<LeaguePlayer> getPlayer(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
