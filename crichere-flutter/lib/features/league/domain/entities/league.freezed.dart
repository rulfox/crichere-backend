...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is League&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.format, format) || other.format == format)&&(identical(other.rulesUrl, rulesUrl) || other.rulesUrl == rulesUrl)&&(identical(other.mustSellAll, mustSellAll) || other.mustSellAll == mustSellAll)&&(identical(other.playerOrderMode, playerOrderMode) || other.playerOrderMode == playerOrderMode)&&(identical(other.waitingListMode, waitingListMode) || other.waitingListMode == waitingListMode)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.bannerUrl, bannerUrl) || other.bannerUrl == bannerUrl)&&(identical(other.status, status) || other.status == status)&&(identical(other.auctionDate, auctionDate) || other.auctionDate == auctionDate)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other.auctionIds, auctionIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,format,rulesUrl,mustSellAll,playerOrderMode,waitingListMode,logoUrl,bannerUrl,status,auctionDate,createdBy,const DeepCollectionEquality().hash(auctionIds));

@override
String toString() {
  return 'League(id: $id, name: $name, format: $format, rulesUrl: $rulesUrl, mustSellAll: $mustSellAll, playerOrderMode: $playerOrderMode, waitingListMode: $waitingListMode, logoUrl: $logoUrl, bannerUrl: $bannerUrl, status: $status, auctionDate: $auctionDate, createdBy: $createdBy, auctionIds: $auctionIds)';
}
...
/// Create a copy of League
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? format = freezed,Object? rulesUrl = freezed,Object? mustSellAll = null,Object? playerOrderMode = null,Object? waitingListMode = null,Object? logoUrl = freezed,Object? bannerUrl = freezed,Object? status = null,Object? auctionDate = freezed,Object? createdBy = null,Object? auctionIds = null,}) {
...
as String,auctionIds: null == auctionIds ? _self.auctionIds : auctionIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
@override@JsonKey() List<String> get auctionIds {
  if (_auctionIds is EqualUnmodifiableListView) return _auctionIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_auctionIds);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _League&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.format, format) || other.format == format)&&(identical(other.rulesUrl, rulesUrl) || other.rulesUrl == rulesUrl)&&(identical(other.mustSellAll, mustSellAll) || other.mustSellAll == mustSellAll)&&(identical(other.playerOrderMode, playerOrderMode) || other.playerOrderMode == playerOrderMode)&&(identical(other.waitingListMode, waitingListMode) || other.waitingListMode == waitingListMode)&&(identical(other.logoUrl, logoUrl) || other.logoUrl == logoUrl)&&(identical(other.bannerUrl, bannerUrl) || other.bannerUrl == bannerUrl)&&(identical(other.status, status) || other.status == status)&&(identical(other.auctionDate, auctionDate) || other.auctionDate == auctionDate)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&const DeepCollectionEquality().equals(other._auctionIds, _auctionIds));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,format,rulesUrl,mustSellAll,playerOrderMode,waitingListMode,logoUrl,bannerUrl,status,auctionDate,createdBy,const DeepCollectionEquality().hash(_auctionIds));
...
as String,auctionDate: freezed == auctionDate ? _self.auctionDate : auctionDate // ignore: cast_nullable_to_non_nullable
as DateTime?,createdBy: null == createdBy ? _self.createdBy : createdBy // ignore: cast_nullable_to_non_nullable
as String,auctionIds: null == auctionIds ? _self._auctionIds : auctionIds // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
